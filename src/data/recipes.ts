...
export const recipes: Recipe[] = [
  ...
  // COPYCAT CLASSICS
  {
    ...
    subtitle: 'Crispy, Spicy, Buttermilk-Brined',
    description: "A spot-on copycat of the cult-favorite Popeyes chicken sandwich—buttermilk-brined chicken with a shatteringly crispy crust, spicy mayo, and pickles on a buttery brioche bun.",
    ...
    instructions: [
      'Brine the chicken: For smaller breasts, pound the thicker end to about 1/2" and slice into 4-ounce portions. For larger breasts, butterfly through the center and cut into 4-ounce portions.',
      'In a lidded container, whisk buttermilk, cayenne sauce, smoked paprika, garlic powder, pepper, and onion powder. Submerge chicken, cover, and refrigerate at least 1 hour or up to overnight. Let sit at room temperature for 15 minutes before frying.',
      'Make the spicy mayo: combine all ingredients in a small bowl, cover, and refrigerate until ready to use.',
      'Make the flour dredge in a shallow dish by whisking all dredge ingredients. In a second shallow dish, combine all batter ingredients. Drizzle 3–4 tablespoons of batter into the flour and work it in with your fingers to create craggy bits. Transfer flour to doubled paper bags if using.',
      'In a heavy Dutch oven with a candy thermometer, heat shortening over medium heat to 310°F, then raise heat to medium-high. When oil reaches 340°F, dip each piece of chicken into the batter, then straight into the flour dredge, tossing to fully coat with extra craggy bits.',
      'Carefully add chicken to oil. Temperature will drop—keep it above 315°F. Fry, flipping occasionally, until golden and cooked through, 6–7 minutes. Do not let oil exceed 350°F. Transfer to a wire rack-lined sheet and keep warm in a 200°F oven.',
      'Warm a brioche bun in the microwave for 10 seconds (Popeyes does not toast their buns). Spread spicy mayo on both sides, add 3 pickle slices to the bottom bun, top with fried chicken and the top bun, and serve.'
    ]
  },
  {
    id: 69,
    title: "Copycat McDonald's Filet-O-Fish",
    subtitle: 'Crispy Panko Fish with Melty American Cheese',
    description: "The nostalgic fast-food classic—flaky white fish in a crisp panko crust, melty American cheese, and creamy tartar sauce on a soft toasted potato bun.",
    category: 'Copycat Classics',
    categorySlug: 'copycat',
    time: '30 min',
    servings: 4,
    ...
    ingredients: [
      ...
      '2 cups panko breadcrumbs',
      '2 boneless, skinless white fish filets (such as cod or tilapia), halved crosswise',
    ...
    instructions: [
      'In a shallow bowl, whisk eggs, flour, Dijon, garlic powder, 1/2 tsp salt, and 1/4 tsp pepper. Place panko in another shallow bowl. Season fish all over with salt and pepper.',
      'Pour oil to a depth of 1/2" in a large heavy skillet. Heat over medium until a deep-fry or instant-read thermometer registers 350°F.',
      'Coat each piece of fish with the egg mixture, then dip into panko, gently pressing to adhere. Fry, turning halfway through, until golden brown and just cooked through, 2–3 minutes per side. Transfer to a paper towel-lined plate and season with salt.',
      'Top bottom buns with a slice of American cheese, then fried fish. Spread tartar sauce on top of the fish, close sandwiches, and serve with more tartar sauce alongside.'
    ]
  },
  {
    id: 70,
    title: 'Copycat Cheesecake Factory Original Cheesecake',
    subtitle: 'Tall, Creamy, Strawberry-Glazed',
    description: 'A dead-ringer for the original Cheesecake Factory classic—ultra-creamy New York-style cheesecake on a buttery graham crust, finished with glossy glazed strawberries and a swirl of whipped cream.',
    category: 'Desserts',
    categorySlug: 'desserts',
    time: '8 hours (incl. chilling)',
    servings: 12,
    image: null,
    featured: false,
    ingredients: [
    ...
    instructions: [
      'Crust: Preheat oven to 325°F and grease an 8" or 9" springform pan with cooking spray. In a large bowl, combine graham cracker crumbs, melted butter, and sugar until the mixture resembles wet sand. Press evenly into the bottom and up the sides of the pan. Set aside.',
      'Filling: In a large bowl with a hand mixer (or stand mixer), beat cream cheese and sugar on medium until smooth and fluffy, 2–3 minutes. Add eggs one at a time, beating well after each addition. Stir in vanilla and sour cream. Add flour and salt and beat until just combined.',
      'Pour filling over the crust. Wrap the bottom of the springform pan in aluminum foil, then place in a large roasting pan. Pour in enough boiling water to come halfway up the sides. Carefully transfer to the oven.',
      'Bake until just slightly jiggly, or until the center registers 145°F on a digital thermometer inserted 2 inches deep, about 1 hour 30 minutes. Turn the oven off, prop the door open, and let cool for 1 hour. Transfer to the fridge and chill until completely cool, 5 hours or up to overnight.',

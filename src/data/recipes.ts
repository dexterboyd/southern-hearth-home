...
export const recipes: Recipe[] = [
  ...
  // SOUTHERN CLASSICS
  {
    ...
    featured: false,
    ingredients: [
      '2 lbs large shrimp, boiled and chilled',
      '1 cup mayonnaise',
    ...
    instructions: [
      'Whisk together mayonnaise, mustard, horseradish, ketchup, and hot sauce.',
      'Add garlic, green onions, parsley, and lemon juice.',
      'Season with salt and pepper.',
      'Chill sauce for at least 1 hour.',
      'Serve shrimp on a bed of lettuce with remoulade drizzled over.'
    ]
  },
  {
    id: 12,
    ...
    featured: false,
    ingredients: [
      '2 lbs beef round or veal, cut into medallions',
      '1/4 cup flour',
      '1/4 cup oil',
      '1 large onion, diced',
      '1 green bell pepper, diced',
    ...
    instructions: [
      'Season meat with Creole seasoning. Dredge in flour.',
      'Brown meat in oil. Remove and set aside.',
      'Sauté onion, bell pepper, and celery in the drippings.',
      'Add tomatoes, broth, and seasonings.',
      'Return meat to pot, cover, and simmer 2 hours until tender.',
      'Cook grits in water and milk until creamy.',
      'Serve grillades over grits.'
    ]
  },
  {
    id: 13,
    ...
    ingredients: [
      ...
      '2 tbsp butter',
      '1 tsp Creole seasoning',
      '6 cleaned crab shells or ramekins'
    ],
    instructions: [
      'Preheat oven to 375°F.',
      'Sauté onion, celery, and garlic in butter until softened.',
      'In a bowl, gently mix crab meat, sautéed vegetables, breadcrumbs, egg, mayonnaise, and seasoning.',
      'Stuff mixture into crab shells.',
      'Top with additional breadcrumbs and dots of butter.',
      'Bake 25-30 minutes until golden brown.'
    ]
  },
  
  // COMFORT FOOD & FAMILY FAVORITES (includes former Sunday Suppers)
  {
    id: 14,
    ...
    instructions: [
      'Season roast generously with Creole seasoning.',
      'Place in slow cooker with onion, garlic, broth, and Worcestershire.',
      'Cook on low 8 hours until falling apart.',
      'Shred beef and return to gravy.',
      'Toast French bread with butter.',
      'Pile beef on bread, dress with mayo, lettuce, tomatoes, and pickles.',
  ...
  },
  {
    ...
    instructions: [
      'Mix rice, eggs, flour, sugar, baking powder, nutmeg, and vanilla.',
  ...
  // RUBS & MARINADES
  {
    ...
    image: null,
    featured: true,
    yield: '1 cup, for 2 racks of ribs or 4-5 lbs of pork shoulder',
    ingredients: [
    ...
    instructions: [
      ...
      'Coat meat liberally, pressing into the meat.',
      'Allow meat to rest 30-60 minutes or refrigerate up to 12 hours.'
    ]
  },
  {
    id: 28,
    ...
    image: null,
    featured: true,
    yield: '1 cup, enough for 4 lbs of chicken, shrimp, or fish',
    ingredients: [
    ...
    instructions: [
      'Mix well and grind fine into a coarse powder.',
      'Apply liberally to meat and let marinate 30 minutes to an hour in the fridge before cooking.'
    ]
  },
  {
    id: 29,
    ...
    image: null,
    featured: true,
    yield: '1 cup, enough for 1 pork shoulder or 6 chicken thighs',
    ingredients: [
      '2 tbsp brown sugar',
      '2 tbsp allspice',
      '2 tsp cinnamon',
    ...
    instructions: [
      ...
      'Marinate in fridge for 4-8 hours or overnight for deeper flavor.'
    ]
  },
  {
    id: 58,
    title: 'Garlic Herb Chicken Dust',
    subtitle: 'Perfect Poultry Seasoning',
    description: 'Aromatic blend of garlic, thyme, and oregano with a hint of lemon. Perfect for chicken or turkey.',
    category: 'Rubs & Marinades',
    categorySlug: 'rubs',
    time: '5 min',
    servings: 6,
    image: null,
    featured: false,
    yield: '2/3 cup, seasons 4-6 chicken quarters or 1 whole chicken',
    ingredients: [
    ...
    instructions: [
      'Mix all ingredients and pulse briefly in a food processor.',
      'Coat chicken with olive oil, then season generously.',
      'Marinate 1 hour if cooking immediately or overnight for better flavor.',
      'Grill, roast, or smoke to 165°F internal temperature.'
    ]
  },
  {
    id: 59,
    title: 'Garlic Butter Steak Blend',
    subtitle: 'Steakhouse Secret',
    description: 'Rich garlic and herb blend that creates restaurant-quality steaks at home.',
    category: 'Rubs & Marinades',
    categorySlug: 'rubs',
    time: '5 min',
    servings: 6,
    image: null,
    featured: false,
    yield: '3/4 cup, seasons 4-6 steaks or 2 lbs of burger meat',
    ingredients: [
      '2 tbsp garlic powder',
      '2 tbsp kosher salt',
    ...
    instructions: [
      ...
      'Pat steaks dry and season generously before cooking.',
      'Brush with melted butter before and after searing.',
      'For compound butter: Mix 2 tbsp seasoning + 1 stick softened butter, roll and refrigerate.'
    ]
  },
  {
    id: 60,
    title: 'Memphis Dry Rib Rub',
    subtitle: 'Competition Style',
    description: 'Classic Memphis-style rub for competition-worthy ribs. No sauce needed.',
    category: 'Rubs & Marinades',
    categorySlug: 'rubs',
    time: '5 min',
    servings: 8,
    image: null,
    featured: false,
    yield: '3/4 cup, seasons 1-2 slabs of ribs (3-5 lbs)',
    ingredients: [
      '1/4 cup brown sugar',
      '2 tbsp paprika',
      '2 tbsp chili powder',
    ...
    instructions: [
      'Combine all ingredients and apply liberally on all sides.',
      'For maximum flavor and bark, let ribs sit uncovered in fridge overnight before smoking.'
    ]
  },
  {
    id: 61,
    title: 'Creole Seasoning',
    subtitle: 'Louisiana Essential',
    description: 'The essential Creole blend for jambalaya, dirty rice, and all your Louisiana favorites.',
    category: 'Rubs & Marinades',
    categorySlug: 'rubs',
    time: '5 min',
    servings: 12,
    ...
    instructions: [
      ...
      'Use to season any Creole or New Orleans dish.'
    ]
  },
  {
    id: 62,
    title: 'Carolina Gold Mustard Sauce',
    subtitle: 'South Carolina Staple',
    description: 'Tangy and bold with a bite. Perfect for chopped pork, ribs, or chicken wings.',
    category: 'Rubs & Marinades',
    categorySlug: 'rubs',
    time: '15 min',
    servings: 12,
    ...
    instructions: [
      ...
      'Great for chopped pork, ribs, or as a glaze for chicken wings.'
    ]
  },
  {
    id: 63,
    title: 'Alabama White Sauce',
    subtitle: 'Tangy & Creamy',
    description: 'Tangy, creamy, and peppery. Perfect for smoked chicken. A Big Bob Gibson original.',
    category: 'Rubs & Marinades',
    categorySlug: 'rubs',
    time: '10 min',
    servings: 16,
    ...
    instructions: [
      ...
      'Baste, drizzle, or dunk whole chicken in sauce.',
      'Chill remainder and allow flavors to meld.'
    ]
  },
  {
    id: 64,
    title: 'Kansas City Classic BBQ Sauce',
    subtitle: 'The Crowd Pleaser',
    description: 'Thick, sweet, and smoky—the ultimate crowd-pleaser. Perfect for ribs, chicken, and brisket.',
    category: 'Rubs & Marinades',
    categorySlug: 'rubs',
    time: '20 min',
    servings: 16,
    ...
    instructions: [
      ...
      'Simmer over medium heat 15-20 minutes, stirring occasionally.',
      'Glaze over slow-cooked ribs, chicken, pork, or brisket.'
    ]
  },
  ...
  },
  {
    ...
    subtitle: 'New Orleans Candy-Shop Flavor',
    description: 'Everything you love about pralines baked into a soft, chewy cookie. Buttery, nutty, and sweet.',
    category: 'Desserts',
    categorySlug: 'desserts',
    time: '30 min',
    servings: 24,
    ...
    instructions: [
      ...
      'Stir in flour, baking soda, and salt. Fold in pecans.',
      'Scoop dough onto sheet.',
      'Bake 10-12 minutes until edges are golden.',
      'Cool on wire rack. Optional: drizzle with caramel.'
    ]
  },
  {
    id: 67,
